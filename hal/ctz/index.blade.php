                ...
                <div class="card p-4">
                    <div class="card-body">
                        <table id="table-kk" class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td>17802011199980008</td>
                                    <td>Machiaveli</td>
                                    <td>
                                        <div><b>Alamat: </b>Jln. Makmur 8</div>
                                        <div><b>Tanggal Lahir: </b>20/11/1998</div>
                                        <div><b>Gol Darah: </b>B</div>
                                        <div><b>Agama: </b>Protestan</div>
                                    </td>
                                    <td>1 - 1875697555482</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
